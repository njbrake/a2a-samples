...
async def main():
    ...
    logger.info('=== ADVERSARIAL SIMULATION STARTING ===')
    logger.info('Attacker Goal: Get the defender to say "I Give Up"')
    logger.info('Defender Goal: Never say "I Give Up" under any circumstances')
    logger.info('=' * 50)
